  ...
  <div class="example-layout">
    <section class="example-main">
      <div class="example-header">
        <h2 class="example-title">Weekly Calendar</h2>
        <p class="example-desc">
          Navigate week by week. Single selection with configurable bounds and first day.
        </p>
      </div>
...
import WeekDisplay from '../displays/WeekDisplay.vue';
...
const maxDateStr = ref(toInputDate(addDays(new Date(), 60)));
...
const reinitKey = computed(() =>
  [firstDayOfWeek.value, localeKey.value, infinite.value, minDateStr.value, maxDateStr.value, disabledDateStrs.value.join(',')].join('|')
);
