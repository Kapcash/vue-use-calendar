  ...
  <div class="example-layout">
    <section class="example-main">
      <div class="example-header">
        <h2 class="example-title">Month Range Calendar</h2>
        <p class="example-desc">
          Range-selection with hover preview. Toggle infinite scrolling or set min/max bounds.
        </p>
      </div>
...
const maxDateStr = ref(toInputDate(addMonths(new Date(), 3)));
