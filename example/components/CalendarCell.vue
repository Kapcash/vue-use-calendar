  ...
  >
    <button
      ...
      :class="{
        ...
        'cell--range-start': day.state.isRangeStart,
        'cell--range-end': day.state.isRangeEnd,
...
.cell--range-start:not(:disabled).cell--between {
  border-radius: 8px 0 0 8px;
}

.cell--range-end:not(:disabled).cell--between {
